      ...
      <div className="flex flex-col h-1/2 gap-[1px]">
        <div className="flex w-full h-full border-animation bg-background flex flex-col">
          ...
          <div className="flex flex-row justify-around grid grid-cols-5 items-center">
            <img src="/images/experience/lazer-logo.png" alt="Lazer Technologies Logo" className="col-span-1"/>
            <img src="/images/experience/wealthagile-logo.png" alt="WealthAgile Logo" className="col-span-1"/>
            <img src="/images/experience/bitbuy-logo.png" alt="Bitbuy Logo" className="col-span-1"/>
            <img src="/images/experience/tablo-logo.png" alt="Tablo Creative Logo" className="col-span-1"/>
            <img src="/images/experience/loopio-logo.png" alt="Loopio Logo" className="col-span-1"/>
          </div>
        </div>
